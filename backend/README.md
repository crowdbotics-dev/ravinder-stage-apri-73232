...
## Project Structure
    ...
    ├── ravinder_stage_apri_73232  # Django project configurations
...
1. Clone this repo and `cd ravinder_stage_apri_73232`
...
2. Clone this repo and `cd ravinder_stage_apri_73232`
